...
public class NewInstructorPage extends TitledPage {

    public NewInstructorPage(Stage primaryStage) {
        super(primaryStage, "New Instructor");
        ...
        existingUserButton.setOnAction(e -> primaryStage.setScene(new InstructorLoginPage(primaryStage)));
